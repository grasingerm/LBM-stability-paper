...
\newcommand{\copt}{\boldsymbol{\Omega}}
...
The BE is given as $\frac{\partial f}{\partial t} + \pvel \cdot \grad f = \copt$, where $f = f(\pos, \pvel, t)$ is the particle velocity distribution function, $\pos$ is the spatial position vector, $\pvel$ is the particle velocity, $\mvel$ is the macroscopic velocity, and $\copt$ is the collision operator.
