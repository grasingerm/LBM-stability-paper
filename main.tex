...
All filtering schemes suffered from the approximately the same level of noise.
...
% A natural question may be to ask ``if the strength of the MRT collision operator is damping out the ghost modes, then is the noise for the BGK with $m = 10^8$ due to the ghost modes?''.
% MG: maybe plot ghost modes for BGK and MRT
