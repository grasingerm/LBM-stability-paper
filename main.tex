...
The lattice Boltzmann method (LBM) is a numerical method for fluid flow that has the unique advantage that computing the strain rate is local to each node.
