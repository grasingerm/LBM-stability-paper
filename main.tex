...
\end{equation}
\noindent which is equivalent with the relationship to the collision frequency, $\omega$, in the BGK sense.
...
\vspace{20cm}
\begin{tabulary}{\linewidth}{l l r r r r r r r r} \label{tab:poise-bing}
