...
\begin{enumerate}
	\item \emph{Yield stress fluids}. Yield stress fluids do not flow until a threshold value of stress, referred to as its yield stress, is exceeded.
	...
	\item \emph{Other}. Many fluids have behavior that can be idealized as a combination of the two ways described above. Other fluids behave in another manner entirely.
\end{enumerate}
