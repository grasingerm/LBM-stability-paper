...
For all simulations presented in this section, the apparent viscosity was approximated using its corresponding constitutive relationship and the Picard-type algorithm outlined in \Fref{sec:lbm-for-nnf} with the stopping criteria set as (whichever was first) a maximum number of iterations set at 15 and the convergence criteria:
...
For the Bingham plastic numerical tests the Reynold's number was varied with the following values:$[100, 1000, 5000, 10000]$, and the Bingham number was varied with the following values: $[1, 10, 100]$ ($Bn$ and $Re$ were calculated the same as in \Fref{sec:poise-bing}).
...
For the power-law numerical tests the Reynold's number was varied with the following values: $[100, 1000, 5000, 10000]$, and the flow behavior index, $n$, was varied with the following values: $[0.5, 1.5]$ ($Re$ was calculated the same as in \Fref{sec:poise-powerlaw}).
