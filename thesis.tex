...
\Fref{cha:lbm-stability} is a numerical investigation of the accuracy, stability, and computational efficiency of different LBM models in simulating non-Newtonian flows.

Once the ground-work has been laid for simulating non-Newtonian flows using LBM, the algorithm was extended in \Fref{cha:lbm-cement} to incorporate simulation of free-surface flows.
