...
\dot{\gamma} = \sqrt{2 \sum_{\alpha,\beta=1}^{2} \srtensor}.
\end{equation}
...
For the Bingham plastic numerical tests the Reynold's number was varied, $Re = 100, 1000, 5000, 10000$, and the Bingham number was varied, $Bn = 1, 10, 100$ ($Bn$ and $Re$ were calculated the same as in \Fref{sec:poise-bing}).
